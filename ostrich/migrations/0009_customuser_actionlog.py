# Generated by Django 5.1.6 on 2025-03-14 01:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ostrich', '0008_costcategory_cost'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('worker', 'Worker'), ('owner', 'Owner'), ('admin', 'Admin')], default='worker', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='actions', to='ostrich.customuser')),
            ],
        ),
    ]
